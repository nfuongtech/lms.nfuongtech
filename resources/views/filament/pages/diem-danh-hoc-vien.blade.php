...
=======
    <style>
        ...
        .diem-danh-table thead .sticky-col {
            z-index: 30;
        }

        .diem-danh-table tbody .sticky-col {
            z-index: 15;
        }

        .diem-danh-table .col-tt {
            left: 0;
            width: 3.5rem;
        }

        .diem-danh-table .col-ms {
            left: 3.5rem;
            width: 8rem;
        }

        .diem-danh-table .col-name {
            left: 11.5rem;
            min-width: 14rem;
            max-width: 20rem;
        }

        .diem-danh-table thead .sticky-header {
            background: #f3f4f6;
        }
    </style>
            ...
            @if($selectedKhoaHoc)
                <div class="flex items-end gap-2">
                    <button
                        ...
                        class="fi-btn rounded-lg px-4 py-2 text-gray-900 bg-[#CCFFD8] hover:bg-[#b8f5c7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7cdf9c]"
...
=======
                        <table class="diem-danh-table min-w-[1100px] w-full text-sm border">
                            <thead class="bg-gray-100">
                                <tr>
                                    <th class="px-3 py-2 border-b align-middle sticky-col col-tt sticky-header" rowspan="2">TT</th>
                                    <th class="px-3 py-2 border-b align-middle sticky-col col-ms sticky-header" rowspan="2">Mã số</th>
                                    <th class="px-3 py-2 border-b align-middle sticky-col col-name sticky-header" rowspan="2">Họ &amp; Tên</th>
                                    @foreach($khoaHocLichHocs as $lichHoc)
                                    ...
                                    <th class="w-44 min-w-[11rem] px-3 py-2 border-b align-top" rowspan="2">Đánh giá rèn luyện</th>
