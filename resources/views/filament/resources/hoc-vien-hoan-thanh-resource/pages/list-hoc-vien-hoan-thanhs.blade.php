    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-4 text-sm text-gray-600">
                Sử dụng nút <span class="font-semibold text-primary-600">Chọn lọc thông tin</span> trên bảng "Danh sách học viên hoàn thành" để mở bộ lọc nâng cao. Các điều kiện đang áp dụng sẽ hiển thị ngay phía trên bảng.
            </div>
        </div>
