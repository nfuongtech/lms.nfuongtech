...
<x-filament::widget>
    <x-filament::card>
        ...
        <div class="space-y-6">
            <div class="flex flex-wrap items-end gap-4">
                ...
                <label class="flex flex-col text-sm font-medium text-slate-600">
                    ...
                    <select
                        ...
                        multiple
                        size="6"
                        class="mt-1 min-h-[11rem] w-72 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-normal text-slate-700 shadow-sm transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/40"
                    >
            ...
            >
                <canvas x-ref="canvas" class="rounded-xl bg-gradient-to-br from-amber-50 via-white to-slate-100"></canvas>
            </div>
        </div>
    </x-filament::card>
</x-filament::widget>
