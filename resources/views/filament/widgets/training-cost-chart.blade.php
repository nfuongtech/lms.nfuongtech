...
<x-filament::widget>
    <x-filament::card>
        ...
        @php
            ...
            $typeSelectSize = min(max(count($trainingTypeOptions), 4), 10);
        @endphp

        <div class="flex flex-col gap-6 xl:flex-row xl:items-start">
            <div class="w-full space-y-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-4 shadow-sm xl:w-80 2xl:w-96">
            ...
            <div class="flex-1 space-y-6">
                <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div class="sm:col-span-1 xl:col-span-2 rounded-2xl border border-indigo-200 bg-white p-4 shadow-sm">
                        ...
                        @if(!empty($typeTotals))
                            <dl class="mt-3 grid gap-2 md:grid-cols-2">
                                @foreach($typeTotals as $type => $value)
                                    <div class="rounded-xl border border-indigo-100 bg-indigo-50/70 px-3 py-2 text-sm text-indigo-600 shadow-sm">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <div
                        class="relative mt-4 min-h-[18rem] w-full lg:min-h-[22rem]"
                    ...
                    >
                        <canvas x-ref="canvas" class="w-full rounded-xl bg-gradient-to-br from-amber-50 via-white to-slate-100"></canvas>
                    </div>
                </div>
            </div>
        </div>
