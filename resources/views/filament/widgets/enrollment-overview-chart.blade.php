...
<x-filament::widget>
    <x-filament::card>
        ...
        <div class="space-y-6">
            <div class="flex flex-wrap gap-4">
                ...
                <label class="flex flex-col text-sm font-medium text-slate-600">
                    ...
                    <select
                        ...
                        class="mt-1 w-48 min-w-[12rem] rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-normal text-slate-700 shadow-sm transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/40"
                    >
            ...
            >
                <canvas x-ref="canvas" class="rounded-xl bg-gradient-to-br from-slate-50 via-white to-slate-100"></canvas>
            </div>
