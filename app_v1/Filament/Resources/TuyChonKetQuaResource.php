...
class TuyChonKetQuaResource extends Resource
{
    ...
    // Hàm lấy các trạng thái động cho KhoaHocResource
    public static function getTrangThaiOptions(): array
    {
        return self::getModel()::all()->map(fn($item) => $item->gia_tri)->toArray();
    }
}
